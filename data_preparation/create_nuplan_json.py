...
def loop_over_db_files(
    rank=0, workers=1, split_db_list=None, ego_save_dir="", seq_save_dir="", nuplandb_wrapper=None
):
    total_sequence = []
...
if __name__ == "__main__":
    ...
    if split_name == "train":
        ...
        db_path_lists = [
            f"{ROOT}/nuplan-v1.1/splits/trainval/{db_i}.db" for db_i in split_db_list_update
        ]
