...
class ImportTransformer(ast.NodeTransformer):
    ...
    def __init__(
        self, global_dict: dict, base_dict: Optional[dict] = None, filename: Optional[str] = None
    ):
...
class ConfigDict(Dict):
    ...
    def __reduce_ex__(self, proto):
        ...
        if digit_version(platform.python_version()) < digit_version("3.8"):
            return (self.__class__, ({k: v for k, v in super().items()},), None, None, None)
        else:
            return (self.__class__, ({k: v for k, v in super().items()},), None, None, None, None)
